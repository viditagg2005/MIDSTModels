...
def prepare_ml_problem(train, test, info):
    ...
    train_X, train_y, label_encoder, encoders, cmax, cmin = feat_transform(
        train, info, train_concatenated=train_concatenated
    )
    test_X, test_y, _, _, _, _ = feat_transform(
        ...
        cmax,
        cmin,
        train_concatenated=train_concatenated,
    )
